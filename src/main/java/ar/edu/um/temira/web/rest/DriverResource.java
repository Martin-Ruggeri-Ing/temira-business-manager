...
/**
 * REST controller for managing {@link ar.edu.um.temira.domain.Driver}.
 */
@RestController
...
public class DriverResource {
    ...
    public ResponseEntity<List<DriverDTO>> getAllDrivers(
        ...
        if ("sleepdetector-is-null".equals(filter)) {
            LOG.debug("REST request to get all Drivers where sleepDetector is null");
            return new ResponseEntity<>(driverService.findAllWhereSleepDetectorIsNull(), HttpStatus.OK);
        }
