...
import { sampleWithRequiredData } from '../statement.test-samples';
...
describe('Statement Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.statements?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to statementService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getStatementIdentifier');
      const id = comp.trackId(entity);
      expect(service.getStatementIdentifier).toHaveBeenCalledWith(entity);
