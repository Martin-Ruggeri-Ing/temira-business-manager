...
import { sampleWithRequiredData } from '../vehicle-brand.test-samples';
...
describe('VehicleBrand Management Component', () => {
  let comp: VehicleBrandComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(VehicleBrandComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.vehicleBrands?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to vehicleBrandService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getVehicleBrandIdentifier');
      const id = comp.trackId(entity);
      expect(service.getVehicleBrandIdentifier).toHaveBeenCalledWith(entity);
