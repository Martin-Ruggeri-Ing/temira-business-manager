...
import { sampleWithRequiredData } from '../sleep-detector.test-samples';
...
describe('SleepDetector Management Component', () => {
  let comp: SleepDetectorComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(SleepDetectorComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.sleepDetectors?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to sleepDetectorService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getSleepDetectorIdentifier');
      const id = comp.trackId(entity);
      expect(service.getSleepDetectorIdentifier).toHaveBeenCalledWith(entity);
