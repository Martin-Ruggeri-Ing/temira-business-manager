...
export class DriverComponent implements OnInit {
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.driverService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
